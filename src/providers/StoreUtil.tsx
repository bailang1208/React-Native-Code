...
export const _retrieveStoreData = async (key: string) => {
  try {
    ...
    console.log(
      '--------------- Occured Storage Fetching Data error --------------',
    );
    console.log(error);
  }
};
...
export const _setStoreData = (key: string, val: any) => {
  try {
    ...
    // Error retrieving data
    console.log(
      '--------------- Occured Storage Setting Data error --------------',
    );
    console.log(error);
  }
};
...
export const _removeStoreKey = async (key: string) => {
  try {
    ...
    console.log(
      '--------------- Occured Storage Removing Key error --------------',
    );
    console.log(error);
  }
};
...
export const s_setSpinner = (status: boolean) => {
  try {
    _setStoreData(STORAGE_KEY.IS_SPINNER, status);
  } catch (err) {
    return null;
  }
};

export const s_isSpinner = async () => {
  try {
    return JSON.parse(await _retrieveStoreData(STORAGE_KEY.IS_SPINNER));
  } catch (err) {
    return null;
  }
};
